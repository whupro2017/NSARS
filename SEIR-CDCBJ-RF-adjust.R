...
plot (S * N ~ time, data = output, type='l', ylim = c(0,W * 1.2), col = 'blue', ylab = 'S, E, I, R', main = '北京变化预测（总量减少）') 
...
par (new = TRUE)                                              
# recovered hosts over time                                   
plot (city[,c("Beijing")] ~ city[,c("Time")], type='o',xlim = c(0,200), ylim = c(0,W * 1.2))
# remain on same frame
par (new = TRUE) 
